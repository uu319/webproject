            ...
            <div class="col-lg-4">
                <div class="jumbotron" style="margin-top:40px;">
                     <form id="form" action="<?php echo base_url('grading/regTeacher')?>" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                        <img src="<?php echo base_url('assets/images/teacher.jpg')?>" alt="Avatar" style="width:50%; margin-left:25%; margin-top:2px; margin-bottom:3px;">
                        </div>
                        ...
                        <input type="submit" class="btn btn-dark form-control">Register</a>
                         <div class="alert alert-success" id="success" style="display:none; margin-top:20px"></div>
                        Already have an account? <a href="<?php echo base_url('grading/v_tLogin')?>">Login now</a>
                    </form>
                </div>
            </div>
